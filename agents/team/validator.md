---
name: validator
description: Read-only validation agent that checks if a task was completed successfully. Verifies work meets acceptance criteria without modifying files.
model: opus
